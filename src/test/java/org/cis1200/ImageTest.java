...
public class ImageTest {
    ...
    public void testReducePalette() {
        PixelPicture pic = new PixelPicture(LOCATION + "ItalyRP512.png");
        PixelPicture pic2 = AdvancedManipulations.reducePalette(ITALY, 512);
        SimpleManipulations.compare2dArray(pic.getBitmap(), pic2.getBitmap());
        assertEquals(
                0,
                PixelPicture.diff(
    ...
    public void testBlur() {
        PixelPicture pic = new PixelPicture(LOCATION + "ItalyBlur2.png");
        PixelPicture pic2 = AdvancedManipulations.blur(ITALY, 2);
        SimpleManipulations.compare2dArray(pic.getBitmap(), pic2.getBitmap());
        assertEquals(
                0,
                PixelPicture.diff(
